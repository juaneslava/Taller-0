...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar el pa�s de cierto atleta");
	...
	{	
		System.out.println("\n" + "Pais de un atleta dado" + "\n");
		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
		Pais pais = calculadora.paisAtleta(nombre_atleta);
		System.out.println("El atleta " + nombre_atleta + " es del pais " + pais.darNombre());
	}
}
